...
export class BicoTokenImplementation extends ethereum.SmartContract {
  static bind(address: Address): BicoTokenImplementation {
    return new BicoTokenImplementation("BicoTokenImplementation", address);
  }
